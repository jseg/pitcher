...
#define PULL_COUNTER        18      //pseudo encoder
...
#define SOUND_CRACK         12     // the pin number for "READY"                 Sound    input PIn
#define SOUND_GRUNT         11     // the pin number for "Load To Explode"       Sound    input PIn
#define SOUND_FOUR          10     // the pin number for "GRUNT"                 Sound    input PIn
#define SOUND_FIVE          9      // the pin number for "Crack"                 Sound    input PIn
